    ...
    <div class="max-w-4xl mx-auto px-6 py-12">
      ...
      <div class="mb-12">
        <div class="flex gap-2 mb-4">
          ...
          <span class="px-3 py-1 bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400 text-xs rounded-full font-medium">PHP</span>
        </div>
...
.warning-box { @apply p-4 rounded-lg bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-sm text-red-700 dark:text-red-300; }
</style>
