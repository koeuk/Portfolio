...
const translations: Translations = {
  ...
  "experience.1.web_interface.title": { en: "🌐 Web Interface (User)", km: "🌐 ផ្ទាំងបណ្តាញ (អ្នកប្រើប្រាស់)", zh: "🌐 Web 界面（用户）" },
  "experience.1.web_interface.discovery.label": { en: "Discovery & Viewing", km: "ស្វែងរក និង កម្សាន្ត", zh: "发现与观看" },
  ...
  "experience.1.web_interface.discovery.homepage": { en: "Responsive grid video feed", km: "ផ្ទាំងវីដេអូឆ្លាតវៃ", zh: "响应式视频流" },
  "experience.1.web_interface.discovery.search": { en: "Keyword-based filtering", km: "ស្វែងរកដោយប្រើពាក្យគន្លឹះ", zh: "关键词搜索" },
  "experience.1.web_interface.discovery.watch_page": { en: "Playback with interactions", km: "ផ្ទាំងមើល និង អន្តរកម្ម", zh: "播放与交互" },
  "experience.1.web_interface.discovery.subscriptions": { en: "Follow creative channels", km: "តាមដានអ្នកបង្កើតមាតិកា", zh: "关注创作频道" },
  "experience.1.web_interface.discovery.history": { en: "Chronological watch logs", km: "ប្រវត្តិវីដេអូដែលបានមើល", zh: "历史观看记录" },
  
  "experience.1.web_interface.interaction.label": { en: "Social Interaction", km: "ទំនាក់ទំនងសង្គម", zh: "社交互动" },
  ...
  "experience.1.web_interface.interaction.comments": { en: "Threaded comment system", km: "ប្រព័ន្ធមតិយោបល់", zh: "分级评论系统" },
  "experience.1.web_interface.interaction.channel_pages": { en: "Public creator profiles", km: "ព័ត៌មានលម្អិតរបស់អ្នកបង្កើត", zh: "公开个人主页" },

  "experience.1.web_interface.creator_tools.label": { en: "Creator Studio", km: "ស្ទីឌីយោអ្នកបង្កើត", zh: "创作者工作室" },
  ...
  "experience.1.web_interface.creator_tools.studio_dashboard": { en: "Performance analytics", km: "តារាងវិភាគសមិទ្ធផល", zh: "表现分析" },
  "experience.1.web_interface.creator_tools.video_management": { en: "Upload & Metadata control", km: "គ្រប់គ្រងការបង្ហោះ", zh: "上传与元数据控制" },
  "experience.1.web_interface.creator_tools.engagement_stats": { en: "Real-time viewer metrics", km: "ស្ថិតិអ្នកទស្សនា", zh: "实时观众指标" },

  "experience.1.admin_interface.title": { en: "🛠 Admin Interface", km: "🛠 ផ្ទាំងគ្រប់គ្រង", zh: "🛠 管理界面" },
  "experience.1.admin_interface.overview.label": { en: "Platform Control", km: "គ្រប់គ្រងប្រព័ន្ធ", zh: "平台控制" },
  ...
  "experience.1.admin_interface.overview.dashboard_metrics": { en: "Global system health", km: "សុខភាពប្រព័ន្ធសរុប", zh: "全系统健康状况" },
  "experience.1.admin_interface.overview.system_logs": { en: "Audit & Security logs", km: "កំណត់ហេតុសុវត្ថិភាព", zh: "审计与安全日志" },

  "experience.1.admin_interface.user_content.label": { en: "Moderation Hub", km: "មជ្ឈមណ្ឌលត្រួតពិនិត្យ", zh: "审核中心" },
  "experience.1.admin_interface.user_content.period": { en: "STORAGE", km: "ការផ្ទុក", zh: "存储" },
  "experience.1.admin_interface.user_content.subheading": { en: "Security & Moderation", km: "សុវត្ថិភាព និង ការត្រួតពិនិត្យ", zh: "安全与审核" },
  "experience.1.admin_interface.user_content.user_moderation": { en: "Account access control", km: "គ្រប់គ្រងគណនី", zh: "账户访问控制" },
  "experience.1.admin_interface.user_content.video_approval": { en: "Content review workflow", km: "លំហូរពិនិត្យមាតិកា", zh: "内容审查流程" },
  "experience.1.admin_interface.user_content.storage_management": { en: "Oracle BFILE monitoring", km: "ត្រួតពិនិត្យការផ្ទុកទិន្នន័យ", zh: "Oracle BFILE 监控" },
