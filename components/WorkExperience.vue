      ...
      <div class="relative max-w-4xl mx-auto timeline-content">
        ...
        <div class="relative flex flex-col md:flex-row items-start mb-16 timeline-step timeline-step-2">
          <div class="ml-16 md:ml-0 md:w-1/2 md:pr-12 md:text-right">
            <div class="relative">
              <div class="hidden md:block absolute right-0 top-1/2 translate-x-full w-8 border-t-2 border-dashed border-green-400"></div>
              <div class="absolute -right-4 md:right-auto md:-left-4 top-0 w-14 h-14 rounded-full bg-green-50 dark:bg-green-900/30 border-4 border-green-500 flex items-center justify-center hidden md:flex">
              ...
              <div class="flex flex-wrap gap-2 mt-3 md:justify-end">
                <span class="px-2 py-1 text-xs rounded-full bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400">Vue.js</span>
                <span class="px-2 py-1 text-xs rounded-full bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400">Nuxt.js</span>
                <span class="px-2 py-1 text-xs rounded-full bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400">Shadcn Vue</span>
                <span class="px-2 py-1 text-xs rounded-full bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400">Tailwind CSS</span>
                <span class="px-2 py-1 text-xs rounded-full bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400">REST API</span>
              </div>
            </div>
          </div>
          <div class="hidden md:block w-1/2"></div>
