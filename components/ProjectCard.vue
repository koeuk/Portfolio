<template>
    <div class="card group dark:bg-primary-light dark:border-gray-700 h-full flex flex-col p-3 sm:p-6">
        <!-- Project Image Placeholder -->
        <div
            class="relative h-20 sm:h-40 mb-3 sm:mb-6 overflow-hidden rounded-lg bg-gradient-to-br from-primary to-primary-light flex-shrink-0">
            <div class="absolute inset-0 flex items-center justify-center text-white/20 text-xl sm:text-4xl font-bold">
        ...
        <div class="flex-1 flex flex-col min-h-0">
            <h3 class="text-xs sm:text-lg font-bold mb-1 sm:mb-2 text-primary dark:text-white transition-colors line-clamp-1 sm:line-clamp-none">
        ...
        <div class="flex gap-2 sm:gap-4 pt-2 sm:pt-4 border-t border-gray-100 dark:border-gray-700">
            <a v-if="project.githubUrl" :href="project.githubUrl" target="_blank" rel="noopener noreferrer"
                class="flex items-center gap-1 sm:gap-2 text-gray-700 dark:text-gray-300 transition-colors font-medium text-[10px] sm:text-base">
            ...
            <a v-if="project.liveUrl" :href="project.liveUrl" target="_blank" rel="noopener noreferrer"
                ...
                <span class="hidden sm:inline">{{ t('projects.demo') }}</span>
            </a>
        </div>
    </div>
</template>
